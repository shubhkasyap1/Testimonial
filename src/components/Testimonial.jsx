...
const Testimonial = (props) => {
  ...
  return (
    <div className="flex flex-col w-[85vw] min-h-[500px] md:w-[700px] bg-white justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md">
